...
public class SemanticVersionTest
{
    ...
    {
        SemanticVersion next = SemanticVersion.parse("9.10.11").releaseVersion(SemanticVersionChange.MAJOR);
    ...
    {
        SemanticVersion next = SemanticVersion.parse("9.10.11").releaseVersion(SemanticVersionChange.MINOR);
    ...
    {
        SemanticVersion next = SemanticVersion.parse("9.10.11-SNAPSHOT").releaseVersion(SemanticVersionChange.PATCH);
    ...
    {
        SemanticVersion next = SemanticVersion.parse("9.10.11").releaseVersion(SemanticVersionChange.NONE);
        assertEquals(new SemanticVersion(9, 10, 11), next);
    }
